...
def top_movies():
    ...
    return render_template('movies.html', movie=movie_list, name='Harry')


@app.route('/tables')
def movies_plus():
    movie_dict = {'autopsy of jane do': 02.14,
                  'neon demon': 3.20,
    ...
    return render_template('table_data.html', movie=movie_dict, name='Sally')
